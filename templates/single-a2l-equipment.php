					...
					Additionally, these refrigerants have a new classification, A2L. The A2L classification denotes a mild flammability, which will change how these refrigerants will need to be handled.  *NOTE: A2L- Although Mildly Flammable are extremely difficult to ignite and have low flame speed. 2L refrigerants have a burning velocity of 10 cm/s (3.9 inches per second) or less, making them less likely to sustain combustion after the initial ignition source has been removed. See chart for classification definitions.
							...
							<div class=" row table_wrap shadow mt-5"><!-- wrap -->
								...
								<table class="table_noexpand">
									...
									<tr class="">
										<td class="border-right">
											<strong>Current refrigerants like R-410A and R-134A are classified as A1 with no ability to carry a flame.</strong>
											</td>

										<td class="border-right">
											<strong>To hit the new targeted GWP levels, manufacturers are switching to A2L-classified refrigerants R-32 or R454B which are considered mildly flammable, difficult to ignite, and have a low flame speed.</strong>
											</td>
										<td class="">
											<strong>By comparison, propane, a gas familiar to many HVAC installers and service technicians, is classified as A3 for higher flammability and its explosion potential.</strong>
											</td>
									</tr>
