...
<div class="">
	...
	<div id="COPY_THIS_CONTAINER_TO_BLOOMREACH">
					...
					<div class="col-12 col-lg-11 pt-5 pb-4">
						...
						<div class="header_block">
							...
							<p class="lead">
								...
								<br><br>
								For A2L training highlights and general information, be sure to check out our <a href="https://youtu.be/gzjlNehTdSg" target="_blank">November 2023 training</a> and <a href="https://youtu.be/pI8xhNC5jNo" target="_blank">Q&A sessions</a>.
								<br>
			...
			<div class="container-fluid bg-white">
				<div class="container">
					<div class="row pb-5">
						...
						<div class=" row table_wrap shadow mt-5"><!-- wrap -->
				...
				<style>
					.bg-darkblue-img {
					background: #062655 url(http://victorpared.es/js/wp-content/uploads/2023/12/female_hvac_technician.jpg) no-repeat center center fixed;
			...
			<div class="container">
				<div class="row justify-content-center">
					<div class="col-12 col-lg-6 py-lg-5 text-center">
						<img id="johnstoneLogo" class="d-block mx-auto mt-5 mb-3" width="400px" src="https://victorpared.es/js/wp-content/uploads/2023/11/johnstone-supply-logo-white.png" alt="Johnstone Supply">
		...
		<div class="container-fluid bg-deepblue" style="background-color: #010821;">
			<div class="container">
				<div class="row">
